...
<!-- Modal -->
<head>
<link type='text/css' href='<?= base_url() ?>assets/css/dropzone.scss' rel='stylesheet'>
<script type='text/javascript' src='<?= base_url() ?>assets/js/dropzone.js' ></script>

<link href='https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.css' type='text/css' rel='stylesheet'>
<script src='https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.js' type='text/javascript'></script>
<script>  Dropzone.options.edit_profile = { acceptedFiles: 'image/*', maxFilesize: 1}; </script>
            ...
            <div class="modal-body p-3">
                    <form action="<?php echo base_url();?>edit-profile" method="POST">
                            <div class="form-group">
                                <label>Name</label>
                                <textarea class="form-control" name="name" column="30"><?php echo $profile['name'];?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Bio</label>
                                <textarea class="form-control" name="bio"><?php echo $profile['bio'];?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control-sm" name="born-date" value="<?php $time = strtotime($profile['birthdate']); echo date("Y-m-d",$time);?>"/>
                            </div>
            </div>
...
<div class="modal fade" id="profile-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img class="rounded-circle border mr-2" src="<?php echo base_url().'uploads/'.$profile['image'];?> " width ="150" height="150" />
    ...
    <div class="modal left fade" id="cover-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body text-center">
                <img class="mb-1 img img-fluid" src="<?php echo base_url().'uploads/'.$profile['cover'];?>"/>
                <form action="<?php echo base_url();?>edit-profile" class="dropzone" id="edit-profile">
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Default input" id="inputDefault1" readonly value="<?php echo $this->session->userdata('username');?>">
                    </div>
                    <div class="form-group">
