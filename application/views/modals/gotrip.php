    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="input-text">
                    <form action="<? echo base_url();?>post-submit" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <textarea placeholder="Gotrip here?" name='post' row="0" id="content" class="modal-gotrip"></textarea>
                        ...
                        <div style="height:35px; width:35px;" class="mb-3">
                                <label class="pl-2 ml-5">
                                    ...
                                    <input type='file' name="gotrip-img" style="visibility:hidden;"/>
                                </label>
                        </div>
                </div>
            <div>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-info">Gotrip</button>
            </div>
            </form>
        </div>
    </div>
